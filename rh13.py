...
def update_person():
    ...
    data = (
        entry_nome.get() or None, # type: ignore
        entry_idade.get() or None, # type: ignore
        entry_data_nascimento.get() or None, # type: ignore
        entry_rg.get() or None, # type: ignore
        entry_cpf.get() or None, # type: ignore
        entry_endereco.get() or None, # type: ignore
        entry_bairro.get() or None, # type: ignore # type: ignore
        entry_cidade.get() or None,
        entry_estado.get() or None, # type: ignore
        entry_indicacao.get() or None, # type: ignore
        entry_telefone.get() or None, # type: ignore
        entry_email.get() or None,
        entry_estado_civil.get() or None,
        entry_pis_pasep.get() or None,
        entry_titulo_eleitor.get() or None,
        ...
        entry_salario.get() or None,
        entry_tipo.get() or None,
        entry_expediente1.get() or None, # type: ignore
        person_id
    )
...
root.configure(bg="#F0F0F0")  # Cor de fundo mais clara
...
style.configure("TLabel", background="#F0F0F0", font=("Segoe UI", 12), padding=6)
style.configure("TEntry", padding=6, font=("Segoe UI", 12), relief="flat", borderwidth=2)
style.configure("TButton", padding=8, relief="flat", background="#007ACC", foreground="white", font=("Segoe UI", 12))
style.map("TButton", background=[('active', '#005BA1')])
style.configure("Treeview", font=("Segoe UI", 12), background="#FFFFFF", fieldbackground="#FFFFFF", rowheight=30)
